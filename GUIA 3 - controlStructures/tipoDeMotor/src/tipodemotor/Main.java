...
de una bomba para mover fluidos). Definir una variable tipoMotor y permitir que el usuario ingrese un valor entre 1 y 4. 
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int tipoMotor;
        System.out.println("Ingresa el tipo de motor: (1 al 4)");
